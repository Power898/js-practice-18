 ...
 *  data - вхідні дані.
 */
function checkData(data) { if (Object.keys(data.length > 0)) return data;
  else {
 ...
 */
function parseJson(jsonStr) { try {
 ...
 */
function findEvenNumber(numbers) {try {
  let evenNumber;
 ...
 */
function evaluateExpression(expression) {try {
